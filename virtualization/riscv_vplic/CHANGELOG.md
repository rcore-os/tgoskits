...
- Replaced host-PLIC MMIO passthrough with VM-local PLIC register state and explicit per-VM source ownership.
- Added typed edge/level input APIs and level re-pending across claim/complete.
