...
pub(crate) fn build_dsdt(plan: &X86FirmwarePlan) -> Result<Vec<u8>, AcpiBuildError> {
    ...
    aml.extend(
        crate::boot::acpi::encode_devices_with_interrupt_controllers(
            &plan.configured_devices,
            &[crate::boot::acpi::AcpiInterruptControllerMap::new(
                plan.interrupts.controller,
