...
impl VmRuntimeHandle {
    ...
    pub(crate) fn add_vcpu_task(&self, vcpu_id: usize, vcpu_task: crate::TaskHandle) -> AxVmResult {
    ...
    pub(crate) fn remove_vcpu_task(&self, vcpu_id: usize) -> Option<crate::TaskHandle> {
