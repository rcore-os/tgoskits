...
## [0.6.3](https://github.com/rcore-os/tgoskits/compare/axdevice_base-v0.6.2...axdevice_base-v0.6.3) - 2026-07-29

### Other

- updated the following local packages: ax-memory-addr, axvm-types
