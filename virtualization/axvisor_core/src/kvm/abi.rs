...
pub(in crate::kvm) mod raw {
    pub(in crate::kvm) const KVMIO: u32 = 0xae;

    #[cfg(target_arch = "riscv64")]
    pub(in crate::kvm) const KVM_MAX_VCPUS: usize = 8;
    #[cfg(not(target_arch = "riscv64"))]
    pub(in crate::kvm) const KVM_MAX_VCPUS: usize = 1;
    pub(in crate::kvm) const KVM_MAX_MEMORY_SLOTS: usize = 32;
    pub(in crate::kvm) const KVM_MAX_CPUID_ENTRIES: usize = 256;
    pub(in crate::kvm) const KVM_MAX_MSR_ENTRIES: usize = 256;
    pub(in crate::kvm) const KVM_VCPU_MMAP_SIZE: usize = 0x1000;
    pub(in crate::kvm) const KVM_MSR_LIST_SIZE: u32 = 4;
    pub(in crate::kvm) const KVM_CPUID2_SIZE: u32 = 8;
    pub(in crate::kvm) const KVM_CPUID_ENTRY2_SIZE: usize = 40;
    pub(in crate::kvm) const KVM_MSRS_SIZE: u32 = 8;
    pub(in crate::kvm) const KVM_MSR_ENTRY_SIZE: usize = 16;
    pub(in crate::kvm) const KVM_USERSPACE_MEMORY_REGION_SIZE: u32 = 32;
    pub(in crate::kvm) const KVM_IOEVENTFD_SIZE: u32 = 64;
    pub(in crate::kvm) const KVM_CLOCK_DATA_SIZE: u32 = 48;
    pub(in crate::kvm) const KVM_IRQ_ROUTING_SIZE: u32 = 8;
    pub(in crate::kvm) const KVM_IRQ_ROUTING_ENTRY_SIZE: usize = 48;
    pub(in crate::kvm) const KVM_MAX_IRQ_ROUTES: usize = 4096;
    pub(in crate::kvm) const KVM_IRQ_ROUTING_IRQCHIP: u32 = 1;
    pub(in crate::kvm) const KVM_IRQ_ROUTING_MSI: u32 = 2;
    pub(in crate::kvm) const KVM_IRQFD_SIZE: u32 = 32;
    pub(in crate::kvm) const KVM_IRQFD_FLAG_DEASSIGN: u32 = 1 << 0;
    pub(in crate::kvm) const KVM_IRQFD_FLAG_RESAMPLE: u32 = 1 << 1;
    pub(in crate::kvm) const KVM_IRQFD_VALID_FLAGS: u32 =
        KVM_IRQFD_FLAG_DEASSIGN | KVM_IRQFD_FLAG_RESAMPLE;
    pub(in crate::kvm) const KVM_PIT_CONFIG_SIZE: u32 = 64;
    pub(in crate::kvm) const KVM_PIT_STATE2_SIZE: u32 = 112;
    pub(in crate::kvm) const KVM_PIT_VALID_FLAGS: u32 = 1;
    pub(in crate::kvm) const KVM_SIGNAL_MASK_SIZE: u32 = 4;
    pub(in crate::kvm) const KVM_SIGNAL_MASK_MAX_LEN: usize = 128;
    pub(in crate::kvm) const KVM_ENABLE_CAP_SIZE: u32 = 104;
    pub(in crate::kvm) const KVM_INTERRUPT_SIZE: u32 = 4;
    pub(in crate::kvm) const KVM_MP_STATE_SIZE: u32 = 4;
    pub(in crate::kvm) const KVM_ONE_REG_SIZE: u32 = 16;
    pub(in crate::kvm) const KVM_REG_LIST_SIZE: u32 = 8;
    pub(in crate::kvm) const KVM_X86_REGS_SIZE: u32 = 18 * 8;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_X86_REGS_RFLAGS_OFFSET: usize = 17 * 8;
    pub(in crate::kvm) const KVM_X86_SREGS_SIZE: u32 = 312;
    pub(in crate::kvm) const KVM_X86_FPU_SIZE: u32 = 416;
    pub(in crate::kvm) const KVM_X86_VCPU_EVENTS_SIZE: u32 = 64;
    pub(in crate::kvm) const KVM_X86_DEBUGREGS_SIZE: u32 = 128;
    pub(in crate::kvm) const KVM_X86_XSAVE_SIZE: u32 = 4096;
    pub(in crate::kvm) const KVM_X86_XCRS_SIZE: u32 = 392;
    pub(in crate::kvm) const KVM_X86_LAPIC_STATE_SIZE: u32 = 1024;
    pub(in crate::kvm) const KVM_MP_STATE_RUNNABLE: u32 = 0;
    pub(in crate::kvm) const KVM_MP_STATE_STOPPED: u32 = 5;
    pub(in crate::kvm) const KVM_MEM_ALLOWED_FLAGS: u32 = 0;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const X86_RFLAGS_IF: u64 = 1 << 9;
    pub(in crate::kvm) const KVM_IOEVENTFD_FLAG_DATAMATCH: u32 = 1 << 0;
    pub(in crate::kvm) const KVM_IOEVENTFD_FLAG_PIO: u32 = 1 << 1;
    pub(in crate::kvm) const KVM_IOEVENTFD_FLAG_DEASSIGN: u32 = 1 << 2;
    pub(in crate::kvm) const KVM_IOEVENTFD_VALID_FLAGS: u32 =
        KVM_IOEVENTFD_FLAG_DATAMATCH | KVM_IOEVENTFD_FLAG_PIO | KVM_IOEVENTFD_FLAG_DEASSIGN;
    pub(in crate::kvm) const KVM_INTERRUPT_SET: u32 = u32::MAX;
    pub(in crate::kvm) const KVM_INTERRUPT_UNSET: u32 = u32::MAX - 1;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const MSR_KVM_WALL_CLOCK_NEW: usize = 0x4b56_4d00;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const MSR_KVM_SYSTEM_TIME_NEW: usize = 0x4b56_4d01;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_SYSTEM_TIME_ENABLE: u64 = 1;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_ENOSYS: isize = 1000;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_HC_CLOCK_PAIRING: u64 = 9;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const PVCLOCK_TSC_STABLE_BIT: u8 = 1 << 0;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_RUN_REQUEST_INTERRUPT_WINDOW_OFFSET: usize = 0;
    pub(in crate::kvm) const KVM_RUN_IMMEDIATE_EXIT_OFFSET: usize = 1;
    pub(in crate::kvm) const KVM_RUN_EXIT_REASON_OFFSET: usize = 8;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_RUN_READY_FOR_INTERRUPT_INJECTION_OFFSET: usize = 12;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_RUN_IF_FLAG_OFFSET: usize = 13;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_RUN_FLAGS_OFFSET: usize = 14;
    pub(in crate::kvm) const KVM_RUN_IO_DIRECTION_OFFSET: usize = 32;
    pub(in crate::kvm) const KVM_RUN_IO_SIZE_OFFSET: usize = 33;
    pub(in crate::kvm) const KVM_RUN_IO_PORT_OFFSET: usize = 34;
    pub(in crate::kvm) const KVM_RUN_IO_COUNT_OFFSET: usize = 36;
    pub(in crate::kvm) const KVM_RUN_IO_DATA_OFFSET_OFFSET: usize = 40;
    pub(in crate::kvm) const KVM_RUN_IO_DATA_OFFSET: usize = 0x100;
    pub(in crate::kvm) const KVM_EXIT_IO_IN: u8 = 0;
    pub(in crate::kvm) const KVM_EXIT_IO_OUT: u8 = 1;
    pub(in crate::kvm) const KVM_RUN_MMIO_PHYS_ADDR_OFFSET: usize = 32;
    pub(in crate::kvm) const KVM_RUN_MMIO_DATA_OFFSET: usize = 40;
    pub(in crate::kvm) const KVM_RUN_MMIO_LEN_OFFSET: usize = 48;
    pub(in crate::kvm) const KVM_RUN_MMIO_IS_WRITE_OFFSET: usize = 52;
    pub(in crate::kvm) const KVM_EXIT_UNKNOWN: u32 = 0;
    pub(in crate::kvm) const KVM_EXIT_IO: u32 = 2;
    pub(in crate::kvm) const KVM_EXIT_HLT: u32 = 5;
    pub(in crate::kvm) const KVM_EXIT_MMIO: u32 = 6;
    pub(in crate::kvm) const KVM_EXIT_IRQ_WINDOW_OPEN: u32 = 7;
    pub(in crate::kvm) const KVM_EXIT_SHUTDOWN: u32 = 8;
    pub(in crate::kvm) const KVM_EXIT_FAIL_ENTRY: u32 = 9;
    pub(in crate::kvm) const KVM_EXIT_INTR: u32 = 10;
    pub(in crate::kvm) const KVM_EXIT_INTERNAL_ERROR: u32 = 17;
    pub(in crate::kvm) const KVM_EXIT_MEMORY_FAULT: u32 = 39;
    #[cfg(target_arch = "x86_64")]
    pub(in crate::kvm) const KVM_CPUID_FLAG_SIGNIFICANT_INDEX: u32 = 1;
    #[cfg(target_arch = "riscv64")]
    pub(in crate::kvm) const RISCV_S_EXT_VECTOR: usize = (1usize << (usize::BITS - 1)) + 9;
    pub(in crate::kvm) const PAGE_SIZE: u64 = 4096;
    pub(in crate::kvm) const PAGE_SIZE_USIZE: usize = PAGE_SIZE as usize;
    pub(in crate::kvm) const X86_RAX_REG_INDEX: usize = 0;
    pub(in crate::kvm) const SUPPORTED_X86_MSRS: &[u32] = &[
    ...
    pub(in crate::kvm) const fn ioc(type_: u32, nr: u32) -> u32 {
        (type_ << 8) | nr
    }

    pub(in crate::kvm) const fn iow(type_: u32, nr: u32, size: u32) -> u32 {
    ...
    pub(in crate::kvm) const fn ior(type_: u32, nr: u32, size: u32) -> u32 {
    ...
    pub(in crate::kvm) const fn iowr(type_: u32, nr: u32, size: u32) -> u32 {
        const IOC_WRITE: u32 = 1;
        const IOC_READ: u32 = 2;
        const IOC_TYPESHIFT: u32 = 8;
        const IOC_SIZESHIFT: u32 = 16;
