...
//! single-producer/single-consumer slot rings. Hypercalls, GPA mapping, IRQ
...
/// Size in bytes of one opaque queue slot.
pub const IVC_SLOT_SIZE: usize = 256;
/// Size in bytes of the Message V1 frame header.
pub const IVC_MESSAGE_HEADER_SIZE: usize = 24;
/// Maximum logical-message fragment carried by one V1 slot.
pub const IVC_SLOT_FRAGMENT_CAPACITY: usize = IVC_SLOT_SIZE - IVC_MESSAGE_HEADER_SIZE;
/// Number of slots per one-way ring.
pub const IVC_RING_CAPACITY: usize = 32;
