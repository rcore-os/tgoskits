...
cargo xtask starry app qemu -t benchmark/block-io-bench --arch aarch64
cargo xtask starry app qemu -t benchmark/block-io-bench --arch riscv64
cargo xtask starry app qemu -t benchmark/block-io-bench --arch loongarch64
```
