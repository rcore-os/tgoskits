...
export FEATURES="${FEATURES:-plat-dyn,ax-driver/virtio-blk,ax-driver/virtio-net,ax-driver/virtio-gpu,ax-driver/virtio-input,ax-driver/virtio-socket,starry-kernel/input,starry-kernel/vsock}"
export NO_DEFAULT_FEATURES="${NO_DEFAULT_FEATURES:-0}"
export TARGET_SPEC_MODE="${TARGET_SPEC_MODE:-pie}"
export TARGET_SPEC_PATH="${TARGET_SPEC_PATH:-}"
export ARTIFACT_TO_BIN="${ARTIFACT_TO_BIN:-1}"
export STARRY_KALLSYMS_RESERVED="${STARRY_KALLSYMS_RESERVED:-64M}"
