#!/usr/bin/env python3
# scene_2dui_py.py - 2D UI compositing RENDER-scene carpet via PyOpenGL on a surfaceless EGL desktop-GL
...
# the desktop-GL entry points are reached through the current context; a non-empty desktop GL VERSION
# string is the loader working (mirrors the C++ cell's glr_load() assert).
