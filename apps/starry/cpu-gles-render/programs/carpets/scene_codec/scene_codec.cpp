// scene_codec.cpp - streaming/codec-math RENDER-scene carpet on EGL-surfaceless / GLES 3.1 / llvmpipe.
// Same context bring-up + off-screen FBO (RGBA8 + DEPTH24) + glReadPixels harness as
// gles_render_cpp_full_api.cpp. Exercises the codec/streaming math paths that a media pipeline runs
// on the GPU, each asserted against an INDEPENDENT closed-form ("numpy-equivalent") reference in C++:
