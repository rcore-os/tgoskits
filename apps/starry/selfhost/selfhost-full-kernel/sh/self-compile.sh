...
cargo build -p starryos --target riscv64gc-unknown-none-elf --features ax-runtime/display,ax-driver/nvme,ax-driver/virtio-net,ax-driver/virtio-gpu,ax-driver/virtio-input,ax-driver/virtio-socket --offline 2>&1
