...
| 类别 | crate | 说明 |
| --- | --- | --- |
| 块设备 | [drivers/blk/nvme-driver/](drivers/blk/nvme-driver/) | NVMe 协议 |
| 块设备 | [drivers/blk/sdhci-host/](drivers/blk/sdhci-host/) | SD/SDIO/EMMC host |
| 块设备 | [drivers/blk/dwmmc-host/](drivers/blk/dwmmc-host/) | DW MMC host |
| 块设备 | [drivers/blk/sdmmc-protocol/](drivers/blk/sdmmc-protocol/) | SD/MMC command protocol |
| 网络 | [drivers/net/fxmac_rs/](drivers/net/fxmac_rs/) | 飞腾 MAC 网卡 |
| 网络 | [drivers/net/eth-intel/](drivers/net/eth-intel/) | Intel 系列网卡 |
| 中断控制器 | [drivers/intc/arm-gic-driver/](drivers/intc/arm-gic-driver/) | ARM GIC |
| 中断控制器 | [drivers/intc/riscv_plic/](drivers/intc/riscv_plic/) | RISC-V PLIC |
| PCIe | [drivers/pci/pcie/](drivers/pci/pcie/) | PCIe controller |
| USB | [drivers/usb/usb-host/](drivers/usb/usb-host/) | xHCI host（CrabUSB） |
| AI 加速 | [drivers/npu/rockchip-npu/](drivers/npu/rockchip-npu/)、[drivers/tpu/sg2002-tpu/](drivers/tpu/sg2002-tpu/) | NPU/TPU |
...
仓库内置 OS Glue 主要集中在 [drivers/ax-driver/](drivers/ax-driver/)：

| 模块 | 职责 |
| --- | --- |
| [block/](drivers/ax-driver/src/block/) | VirtIO-blk、ramdisk、NVMe、SDHCI、DW MMC、AHCI binding |
| [net/](drivers/ax-driver/src/net/) | VirtIO-net、fxmac、intel-net、realtek、aic8800 binding |
| [display/](drivers/ax-driver/src/display/) | VirtIO-gpu binding |
| [input/](drivers/ax-driver/src/input/) | VirtIO-input binding |
| [vsock/](drivers/ax-driver/src/vsock/) | VirtIO-socket binding |
| [virtio/](drivers/ax-driver/src/virtio/) | VirtIO transport |
| [pci/](drivers/ax-driver/src/pci/) | PCI probe、BAR/window、INTx 解析 |
| [soc/](drivers/ax-driver/src/soc/) | Rockchip SoC glue |
| [usb/](drivers/ax-driver/src/usb/) | xHCI binding |
| [serial/](drivers/ax-driver/src/serial/) | 串口 binding |
| [binding_info.rs](drivers/ax-driver/src/binding_info.rs) | IRQ binding 元数据 |
| [binding_resolver.rs](drivers/ax-driver/src/binding_resolver.rs) | FDT/ACPI/PCI IRQ 解析 |
| [mmio.rs](drivers/ax-driver/src/mmio.rs) | MMIO 映射 helper |
| [registration.rs](drivers/ax-driver/src/registration.rs) | `register_transport*()` helper |
...
| crate | 说明 |
| --- | --- |
| [drivers/net/rd-net/](drivers/net/rd-net/) | 网卡 runtime：waker、buffer pool、IRQ 适配 |
