...
若已知目标 crate 的名称，建议配合 [Crate 索引](/docs/components/crates) 阅读本文档：本文档侧重说明"组件处于哪一层、通常影响哪些系统"，而 crate 索引负责回答"它依赖哪些包、文档入口在哪里"。
...
仓库内 **149** 个 crate 之间的内部有向边共 **533** 条，最大层级 **16**。
