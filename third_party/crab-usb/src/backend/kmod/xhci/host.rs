...
impl Xhci {
    pub fn new(mmio: Mmio, kernel: &'static dyn KernelOp) -> Result<Self> {
        ...
        // RK3588 DWC3 reports AC64, but the board DT routes this controller through a
        // 32-bit DMA window. Keep xHCI allocations under 4 GiB so UVC traffic cannot
        // corrupt unrelated devices such as the PCIe RTL8125 NIC.
