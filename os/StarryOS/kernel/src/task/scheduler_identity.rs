...
#[cfg(axtest)]
fn published_scheduler_identity_check_is_read_only_for_test() -> bool {
...
mod axtests {
    #[axtest::axtest]
    fn published_scheduler_identity_check_is_read_only() {
        assert!(super::published_scheduler_identity_check_is_read_only_for_test());
    }
}
