...
#[cfg(axtest)]
pub(crate) fn dropped_exit_path_lease_keeps_unfinished_work_pending_for_test() -> bool {
...
#[cfg(axtest)]
pub(crate) fn exit_path_completion_precedes_task_transfer_for_test() -> bool {
    let namespace = Arc::new(PidNamespace::new_root());
