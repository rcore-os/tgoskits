...
fn check_nodemask(nodemask: *const usize, maxnode: usize) -> StarryResult<()> {
...
pub fn sys_umask(mask: u32) -> StarryResult<isize> {
    let curr = current();
...
pub fn sys_set_mempolicy(mode: i32, nodemask: *const usize, maxnode: usize) -> StarryResult<isize> {
