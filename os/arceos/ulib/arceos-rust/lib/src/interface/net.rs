...
pub fn sys_freeaddrinfo(addr_info: *mut HermitAddrInfo) {
    ...
    unsafe { ax_posix_api::sys_freeaddrinfo(&mut info) }
...
pub fn sys_getaddrinfo(
    ...
    unsafe { ax_posix_api::sys_getaddrinfo(nodename, servname, hints, res) }
}
...
pub fn sys_connect(socket_fd: i32, name: *const sockaddr, namelen: socklen_t) -> i32 {
    ...
    ax_posix_api::sys_connect(socket_fd, &name_converted, namelen)
}
