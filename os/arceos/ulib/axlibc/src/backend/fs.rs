...
use super::fd_table::{FileLike, get_file_like};
...
impl File {
    ...
    fn add_to_fd_table(self) -> LinuxResult<c_int> {
        super::fd_table::add_file_like(Arc::new(self))
    }

    fn from_fd(fd: c_int) -> LinuxResult<Arc<Self>> {
        let f = super::fd_table::get_file_like(fd)?;
        f.into_any()
            .downcast::<Self>()
...
impl Directory {
    fn new(_inner: ax_fs_ng::fops::Directory) -> Self {
        Self
    }
