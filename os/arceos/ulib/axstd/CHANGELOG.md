...
## [0.5.32](https://github.com/rcore-os/tgoskits/compare/ax-std-v0.5.31...ax-std-v0.5.32) - 2026-08-10

### Other

- updated the following local packages: ax-runtime, ax-driver, ax-hal, ax-task, ax-api, ax-posix-api
