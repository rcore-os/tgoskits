...
## [0.5.30](https://github.com/rcore-os/tgoskits/compare/ax-std-v0.5.29...ax-std-v0.5.30) - 2026-07-29

### Other

- updated the following local packages: ax-kspin, ax-lazyinit, axbacktrace, ax-errno, ax-io, ax-driver, ax-hal, ax-task, ax-runtime, ax-alloc, ax-api, ax-posix-api
