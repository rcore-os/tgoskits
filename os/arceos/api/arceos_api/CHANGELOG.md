...
## [0.7.5](https://github.com/rcore-os/tgoskits/compare/ax-api-v0.7.4...ax-api-v0.7.5) - 2026-07-21

### Other

- updated the following local packages: ax-io, axpoll, ax-hal, ax-task, ax-fs-ng, ax-net, ax-runtime, ax-alloc, ax-ipi, ax-mm, ax-sync, ax-display, ax-dma
