...
ifeq ($(PLAT_DYN),y)
  RUSTFLAGS_LINK_ARGS := -C relocation-model=pic -C link-arg=-pie -C link-arg=-znostart-stop-gc -C link-arg=-Truntime.x
else
  RUSTFLAGS_LINK_ARGS := -C link-arg=-Truntime.x -C link-arg=-no-pie -C link-arg=-znostart-stop-gc
endif
