...
#[cfg(feature = "sleep")]
pub use crate::lockdep_core::LockSubclass;
pub use crate::lockdep_core::{
    DEFAULT_LOCK_SUBCLASS, HeldLock, HeldLockKind, HeldLockSnapshot, HeldLockStack, LockdepMap,
    LockdepOps, PreparedAcquire, current_task_held_lock_snapshot,
};
