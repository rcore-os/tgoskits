...
pub struct QperfRuntimeSchedulerMetricsSnapshot {
    pub task: ax_task::diagnostics::QperfSchedulerMetricsSnapshot,
...
pub fn qperf_runtime_scheduler_metrics_snapshot() -> QperfRuntimeSchedulerMetricsSnapshot {
    ...
    QperfRuntimeSchedulerMetricsSnapshot {
        task: ax_task::diagnostics::qperf_scheduler_metrics_snapshot(),
...
fn account_clock_event(
    ...
    match ax_task::runtime::service::on_clock_event(
        now,
...
pub(crate) fn publish_scheduler_tick(
    stamp: ax_task::runtime::service::SchedulerTickStamp,
    mode: ax_task::runtime::service::SchedulerTickMode,
    tick_ns: u64,
) {
    ax_task::runtime::service::publish_scheduler_tick(stamp, mode, tick_ns)
