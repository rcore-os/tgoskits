...
const fn clock_event_requests_reschedule(
    slice_expired: bool,
...
#[cfg(feature = "irq")]
pub(crate) fn on_clock_event(now_ns: u64) -> Option<ax_task::runtime::TaskDeadlineUpdate> {
...
#[cfg(any(feature = "ipi", feature = "wake-ipi"))]
fn publish_scheduler_ipi_doorbell(cpu_id: usize) -> RuntimeStatus {
...
fn publish_then_notify_scheduler_ipi(
