...
use crate::{
    RuntimeError, RuntimeLogContext, RuntimeResult, raw_console::RawConsoleInput, serial,
    sync::SpinLock, write_fallback_record,
};
...
fn publish_raw_record(
    ...
    if write_fallback_record(writer, meta, context, args).is_ok() {
...
mod tests {
    ...
    use crate::{RuntimeError, RuntimeLogContext};
