...
pub use ax_plat::irq::{
    ...
    IrqNumber, IrqOutcome, IrqRequest, IrqReturn, IrqScope, IrqStatus, RawIrqHandler, ShareMode,
    cpu_online, disable_irq, dispatch_irq, enable_irq, free_irq, handle, irq_status, request_irq,
    request_percpu_irq, request_shared_irq, run_on_cpu_sync, set_enable, set_run_on_cpu_sync,
    synchronize_irq,
};
#[cfg(feature = "ipi")]
