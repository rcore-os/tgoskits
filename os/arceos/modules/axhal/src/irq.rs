...
pub use ax_plat::irq::gic_maintenance_irq_status;
#[cfg(feature = "smp")]
...
pub use ax_plat::irq::{
    ...
    IrqCapabilityStatus, IrqContext, IrqDomainId, IrqError, IrqExecution, IrqHandle, IrqId,
    IrqNumber, IrqOutcome, IrqRequest, IrqReturn, IrqScope, IrqSource, IrqStatus,
    ...
    dispatch_irq, enable_irq, free_irq, handle, in_irq_context, init_boot_irqs, irq_status,
    is_cpu_online, legacy_irq, legacy_irq_raw, prepare_irq_context, request_irq,
