...
pub use ax_plat::irq::{
    ...
    prepare_irq_context, request_irq, request_percpu_irq, request_shared_irq, resolve_external_irq,
    resolve_irq_source, resolve_percpu_irq, run_on_cpu_sync, set_affinity, set_enable,
