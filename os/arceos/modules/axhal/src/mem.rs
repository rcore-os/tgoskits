...
pub use ax_plat::mem::{
    ...
    dma_coherent_after_mapping_update, dma_coherent_before_map_uncached,
    dma_coherent_before_unmap_uncached, kernel_aspace, mmio_ranges, phys_ram_ranges, phys_to_virt,
