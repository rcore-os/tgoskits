...
pub use owned::{
    DirectoryCursor, DirectoryEntry, DirectoryEntryType, Ext4, FilePermissions, InodeFlags,
    InodeInfo, InodeMetadataUpdate, MutationContext, SpecialInodeKind, format,
};
pub use sync::umount;
