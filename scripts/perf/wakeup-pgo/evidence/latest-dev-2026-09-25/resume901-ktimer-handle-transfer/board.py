#!/usr/bin/env python3
"""Compare the same-source ktimer handle transfer candidate on Plus-1."""
...
IMAGES = {
    "A": ("resume901-A.bin", BUILD_ARTIFACTS.parent / "resume898-same-mm-fast/ordinary-control.bin"),
    "B": ("resume901-B.bin", BUILD_ARTIFACTS / "ordinary-candidate.bin"),
}
...
def main():
    ...
    assert patch_sha == "31d2a41caaae729ddd3d2003e970b44386efaffd09c8df3a9befda6a793e66dc"
    ...
    while True:
        try:
            session = json.loads(request("/api/v1/sessions", "POST", {
                ...
                "required_tags": [], "client_name": "issue2308-resume901-ktimer-handle-full20",
            }))
            break
