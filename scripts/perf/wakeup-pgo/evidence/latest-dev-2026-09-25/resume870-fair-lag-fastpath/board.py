...
IMAGES = {
    "A": ("resume870-A.bin", ROOT / "A.bin"),
    "B": ("resume870-B.bin", ROOT / "B.bin"),
}
...
def main():
    ...
    while True:
        try:
            session = json.loads(request("/api/v1/sessions", "POST", {
                ...
                "required_tags": [], "client_name": "issue2308-resume870-fair-lag-abba",
            }))
            break
    ...
    try:
        ...
        print("RESUME870_COMPLETE", len(rounds), flush=True)
    finally:
        stop.set()
