...
FROZEN_SOURCE_PATHS = (
    "scripts/benchmark/axvisor-rt/board/board-runner.sh",
    "scripts/benchmark/axvisor-rt/board/build-guest-dtb.sh",
    "scripts/benchmark/axvisor-rt/board/harvest-result.sh",
    "scripts/benchmark/axvisor-rt/board/orangepi-5-plus.dts",
    "scripts/benchmark/axvisor-rt/board/prepare-service-dtb.sh",
    "scripts/benchmark/axvisor-rt/board/restore-linux.sh",
    "scripts/benchmark/axvisor-rt/board/serial-command.sh",
