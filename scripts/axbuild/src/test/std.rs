...
const AX_FS_NG_FEATURE_PROFILES: &[PackageFeatureProfile] = &[
    ...
    PackageFeatureProfile {
        name: "host-test-completion-discovery",
        no_default_features: false,
        features: &["host-test"],
        name_filter: Some("block::runtime::completion::tests::"),
        expected_tests: &[
            "block::runtime::completion::tests::completion_before_first_poll_is_observed",
            "block::runtime::completion::tests::completion_between_waker_registration_and_result_recheck_is_observed",
            "block::runtime::completion::tests::completion_future_delivers_published_result",
            "block::runtime::completion::tests::completion_group_notifies_waiter_once_after_all_members_complete",
            "block::runtime::completion::tests::dropping_pending_future_clears_waker_outside_lock_after_sender_drop",
            "block::runtime::completion::tests::non_final_group_member_wakes_its_own_future",
            "block::runtime::completion::tests::publisher_invokes_waker_after_releasing_the_cell_lock",
            "block::runtime::completion::tests::repeated_poll_replaces_the_registered_waker",
            "block::runtime::completion::tests::receiver_cancel_and_publisher_release_dma_once_outside_the_cell_lock",
            "block::runtime::completion::tests::stale_wake_can_finish_after_the_future_is_dropped",
        ],
    },
    PackageFeatureProfile {
        name: "host-test-waiters-discovery",
        no_default_features: false,
        features: &["host-test"],
        name_filter: Some("block::runtime::waiters::tests::"),
        expected_tests: &[
            "block::runtime::waiters::tests::async_waiter_wake_allows_reentrant_registration",
        ],
    },
    PackageFeatureProfile {
        name: "host-test-async-submission-discovery",
        no_default_features: false,
        features: &["host-test"],
        name_filter: Some("block::runtime::lifecycle::tests::async_submission::"),
        expected_tests: &[
            "block::runtime::lifecycle::tests::async_submission::admission_notification_after_pending_poll_rechecks_the_gate",
            "block::runtime::lifecycle::tests::async_submission::admission_notification_between_check_and_wait_is_observed",
            "block::runtime::lifecycle::tests::async_submission::admission_publisher_invokes_waker_after_releasing_gate_lock",
            "block::runtime::lifecycle::tests::async_submission::admission_state_published_before_first_listener_check_is_observed",
            "block::runtime::lifecycle::tests::async_submission::async_admission_returns_io_after_teardown_begins",
            "block::runtime::lifecycle::tests::async_submission::async_data_submit_waiting_on_flush_gate_returns_dma_when_device_fails",
            "block::runtime::lifecycle::tests::async_submission::async_data_submit_waiting_on_full_channel_returns_dma_when_device_fails",
            "block::runtime::lifecycle::tests::async_submission::async_data_submit_waits_for_full_channel_and_rolls_back_on_cancel",
            "block::runtime::lifecycle::tests::async_submission::async_flush_submit_waiting_on_data_drain_rolls_back_when_device_fails",
            "block::runtime::lifecycle::tests::async_submission::async_flush_nowait_rolls_back_gate_after_data_drain_rejection",
            "block::runtime::lifecycle::tests::async_submission::async_reads_respect_single_hardware_inflight_slot_and_return_dma",
            "block::runtime::lifecycle::tests::async_submission::async_submit_full_channel_returns_retry_when_channel_retires",
            "block::runtime::lifecycle::tests::async_submission::async_submit_keeps_sticky_channel_after_mapping_replacement",
            "block::runtime::lifecycle::tests::async_submission::async_submit_nowait_never_waits_on_channel_owner",
            "block::runtime::lifecycle::tests::async_submission::async_submit_nowait_returns_request_when_channel_is_full",
            "block::runtime::lifecycle::tests::async_submission::async_submit_repoll_replaces_channel_capacity_waker",
            "block::runtime::lifecycle::tests::async_submission::async_submit_returns_owned_request_when_no_cpu_channel_is_available",
            "block::runtime::lifecycle::tests::async_submission::async_submit_waiting_on_full_channel_returns_io_when_device_fails",
            "block::runtime::lifecycle::tests::async_submission::async_submit_waits_for_full_channel_and_rolls_back_on_cancel",
            "block::runtime::lifecycle::tests::async_submission::async_validation_error_returns_prepared_dma_to_the_caller",
            "block::runtime::lifecycle::tests::async_submission::channel_async_waiter_is_woken_after_capacity_is_released",
            "block::runtime::lifecycle::tests::async_submission::channel_capacity_publisher_invokes_waker_after_releasing_state_lock",
            "block::runtime::lifecycle::tests::async_submission::channel_close_wakes_every_async_capacity_waiter",
            "block::runtime::lifecycle::tests::async_submission::data_admission_waits_on_flush_and_rolls_back_when_cancelled",
            "block::runtime::lifecycle::tests::async_submission::dropping_async_completion_receiver_keeps_enqueued_submission",
            "block::runtime::lifecycle::tests::async_submission::flush_admission_holds_and_rolls_back_while_draining_data",
            "block::runtime::lifecycle::tests::async_submission::flush_drain_notification_between_check_and_wait_is_observed",
            "block::runtime::lifecycle::tests::async_submission::flush_gate_notification_between_check_and_wait_is_observed",
            "block::runtime::lifecycle::tests::async_submission::nowait_admission_returns_retry_without_pending",
            "block::runtime::lifecycle::tests::async_submission::ordinary_admission_future_remains_pending_in_nonblocking_context",
            "block::runtime::lifecycle::tests::async_submission::ordinary_channel_wait_remains_pending_in_nonblocking_context",
            "block::runtime::lifecycle::tests::async_submission::permit_release_wakes_sync_and_async_admission_waiters",
            "block::runtime::lifecycle::tests::async_submission::released_capacity_wakes_sync_and_async_channel_waiters",
            "block::runtime::lifecycle::tests::async_submission::second_flush_cancel_and_nowait_preserve_gate_owner",
        ],
    },
    PackageFeatureProfile {
        name: "host-test-nonblocking-channel-owner-lock-discovery",
        no_default_features: false,
        features: &["host-test"],
        name_filter: Some("nonblocking_sender_never_waits_on_channel_owner"),
        expected_tests: &[
            "block::runtime::channel::tests::nonblocking_sender_never_waits_on_channel_owner",
        ],
    },
    PackageFeatureProfile {
        name: "host-test-hctx-channel-lock-discovery",
        no_default_features: false,
        features: &["host-test"],
        name_filter: Some("submission_registry_lock"),
        expected_tests: &[
            "block::runtime::hctx::tests::submission::closing_channels_checks_state_after_releasing_submission_registry_lock",
            "block::runtime::hctx::tests::submission::dequeue_wakes_capacity_listener_after_releasing_submission_registry_lock",
            "block::runtime::hctx::tests::submission::prune_checks_channel_state_after_releasing_submission_registry_lock",
            "block::runtime::hctx::tests::submission::single_dequeue_wakes_after_releasing_submission_registry_lock",
        ],
    },
    PackageFeatureProfile {
