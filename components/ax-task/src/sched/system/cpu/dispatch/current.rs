...
use super::super::*;
use crate::sched::{algorithm::LinkedRqTaskRef, system::task_system::SwitchEndpoint};
...
impl CurrentDispatch {
    ...
    pub(crate) fn address_space(&self) -> crate::runtime::resource::AddressSpaceHandle {
        self.metadata().runtime_binding.address_space()
    }

    pub(crate) fn update_runtime_binding(
        &mut self,
