...
pub(super) struct TaskSystemState {
    ...
    pub(super) pending_address_space_reclaims: Vec<crate::runtime::resource::AddressSpaceToken>,
...
impl DetachedThreadRecord {
    ...
    pub(super) fn release(mut self) -> crate::runtime::resource::AddressSpaceToken {
