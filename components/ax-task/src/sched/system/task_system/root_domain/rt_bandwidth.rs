...
impl RootDomain {
    pub(in crate::sched::system::task_system) fn rt_bandwidth_enabled(&self) -> bool {
        self.rt_bandwidth.enabled()
    }

    pub(in crate::sched::system::task_system) fn activate_rt_period(
        &self,
        cpu: CpuId,
    ...
    pub(in crate::sched::system::task_system) fn enable_rt_runtime(&self, cpu: CpuId) {
        let remote = &self.runqueues[cpu.as_usize()];
    ...
    pub(in crate::sched::system::task_system) fn disable_rt_runtime(&self, cpu: CpuId) {
