...
use super::*;
use crate::sched::system::WakePreemptionContext;

impl TaskSystem {
    pub(in crate::sched::system::task_system) fn activate_owner_rt_period_for_policy(
        &self,
        owner: CpuId,
    ...
    pub(in crate::sched::system::task_system) fn link_owner_throttled_deadline_locked(
        &self,
    ...
    pub(in crate::sched::system::task_system) fn link_owner_ready_thread_locked(
        &self,
        owner: CpuId,
        run_queue: &mut OwnerRqTxn<'_>,
        core: &Arc<ThreadCore>,
    ...
    pub(in crate::sched::system::task_system) fn link_owner_ready_thread_locked_with_context(
        &self,
        owner: CpuId,
        run_queue: &mut OwnerRqTxn<'_>,
        core: &Arc<ThreadCore>,
    ...
    pub(in crate::sched::system::task_system) fn finish_owner_enqueue(
        &self,
        ...
        if reschedule.is_none() && scheduler_deadline_refresh_required && push_class.is_none() {
            cpu.remote().kick_scheduler_work();
        }
    }

    pub(in crate::sched::system::task_system) fn activate_owner_deadline_bandwidth(
        &self,
        core: &Arc<ThreadCore>,
        sched: &mut ThreadSchedState,
        cpu: Pin<&mut CpuLocal>,
    ...
    pub(in crate::sched::system::task_system) fn activate_deadline_bandwidth_locked(
        core: &Arc<ThreadCore>,
        sched: &mut ThreadSchedState,
        run_queue: &mut OwnerRqTxn<'_>,
        owner: CpuId,
    ...
    pub(in crate::sched::system::task_system) fn attach_deadline_bandwidth_locked(
        core: &Arc<ThreadCore>,
        sched: &mut ThreadSchedState,
        run_queue: &mut OwnerRqTxn<'_>,
        owner: CpuId,
    ...
    pub(in crate::sched::system::task_system) fn detach_owner_deadline_bandwidth_in_rq(
        core: &Arc<ThreadCore>,
        sched: &mut ThreadSchedState,
        remote: &CpuRemote,
        run_queue: &mut OwnerRqTxn<'_>,
    ...
    pub(in crate::sched::system::task_system) fn mark_owner_deadline_non_contending_in_rq(
        &self,
        core: &Arc<ThreadCore>,
        sched: &mut ThreadSchedState,
