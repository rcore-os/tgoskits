...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::sched::system::task_system) struct OwnerReadyEnqueue {
    pub(in crate::sched::system::task_system) reschedule: Option<RescheduleKind>,
    pub(in crate::sched::system::task_system) scheduler_deadline_refresh_required: bool,
}
