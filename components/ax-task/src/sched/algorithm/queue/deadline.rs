...
use crate::{
    ...
    sched::{DeadlineBandwidthSnapshot, algorithm::SchedulingEntity},
...
fn deadline_entity(thread: &QueuedThread) -> &crate::thread::DeadlineEntity {
    thread
        .active
        .entity()
        .deadline()
