...
use crate::{sync::irq::IrqWaitCell, thread::TaskError};
...
impl TaskWorkDoorbell {
    ...
    pub(crate) fn publish(&self) {
        ...
        #[cfg(feature = "qperf-metrics")]
        {
            ...
            crate::diagnostics::counters::record_task_work_publish(edge);
        }
    ...
    pub(crate) fn claim_pending(&self) -> Option<TaskWorkClaim> {
        ...
        #[cfg(feature = "qperf-metrics")]
        if claim.is_some() {
            crate::diagnostics::counters::record_task_work_pending_consumed();
        }
        claim
    }
    ...
    pub(crate) fn reassert_pending(&self) {
        ...
        #[cfg(feature = "qperf-metrics")]
        crate::diagnostics::counters::record_task_work_reassertion();
    }
