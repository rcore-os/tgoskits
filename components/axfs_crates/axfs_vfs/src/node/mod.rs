...
impl DirEntry {
    ...
    /// Creates a new directory entry that references an existing directory
    /// node and receives its own weak reference.
    pub fn new_dir_node_cyclic(
