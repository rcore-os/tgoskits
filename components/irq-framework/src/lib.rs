...
pub use types::{
    ...
    ConcurrentBoxedIrqHandler, CpuId, CpuMask, CpuMaskIter, HwIrq, IrqAffinity,
    IrqCapabilityStatus, IrqContext, IrqDomainId, IrqError, IrqExecution, IrqHandle, IrqId, IrqOps,
