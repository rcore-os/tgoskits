...
## [0.7.7](https://github.com/rcore-os/tgoskits/compare/axklib-v0.7.6...axklib-v0.7.7) - 2026-07-29

### Other

- updated the following local packages: dma-api, ax-memory-addr, ax-errno, irq-framework, mmio-api, ax-alloc
