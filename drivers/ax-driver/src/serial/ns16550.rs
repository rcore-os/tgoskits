...
use super::{PlatformSerialDevice, acpi_serial_device_info, prop_u32, serial_device_info};
...
fn acpi_io_serial(info: &AcpiInfo<'_>) -> Result<Option<AcpiSerialResource>, OnProbeError> {
    ...
    let serial = serial_ns16550::Ns16550::new_port_boxed(port, ACPI_NS16550_CLOCK);
...
fn acpi_mmio_serial(info: &AcpiInfo<'_>) -> Result<AcpiSerialResource, OnProbeError> {
    ...
    let serial = serial_ns16550::Ns16550::new_mmio_boxed(
        mmio_base,
        ACPI_NS16550_CLOCK,
