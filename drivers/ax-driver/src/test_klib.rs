//! One host-side `Klib` implementation for the ax-driver library test binary.
//!
//! Unit-test modules share this implementation so combined feature builds do
//! not define the exported axklib hooks more than once. Integration-test
//! binaries provide their own test-only implementation where needed.
