...
// SAFETY: mappings and allocator-owned collections may move with their `Send` handler and allocator.
...
// SAFETY: the platform exposes shared table data and immutable descriptors; both owners are `Sync`.
