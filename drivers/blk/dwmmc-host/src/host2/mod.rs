//! Native host2 transaction and initialization request adapter.
...
use request::{
    BusRequestState, DwMmcClockState, DwMmcFifoResetState, DwMmcResetState, Host2TimedWait,
...
impl sdmmc_protocol::sdio::host2::SdioHost2Timed for DwMmc {
