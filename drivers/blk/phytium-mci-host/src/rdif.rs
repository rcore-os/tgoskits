...
use crate::{BlockRequest, BlockRequestSlot, PhytiumMci, RequestId};

pub fn device(card: SdioSdmmc<PhytiumMci>, config: BlockConfig) -> BlockDevice<PhytiumMci> {
...
impl protocol_rdif::BlockHost for PhytiumMci {
